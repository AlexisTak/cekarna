...
Adresse : http://127.0.0.1:5173. La page d’accueil publique est disponible à la racine. Les formulaires de préparation sont accessibles sur `/inscription` et `/connexion` ; ils valident les saisies mais n’enregistrent aucun mot de passe. L’espace candidat reste accessible avec `?workspace=candidate`. Les vues de l’espace utilisent des fragments d’URL.
