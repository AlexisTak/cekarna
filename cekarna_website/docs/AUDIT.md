...
PDF (`../../documents/sources/cekarna_v2.json`). Les PDF V2 cadrent le B2B
différé ; leurs exigences de preuves, d'isolation et de décision humaine
...
- Les analyses PDF sont en mémoire, accessibles par identifiant opaque ; pas
  ...
  La provenance renvoyée à la confirmation n'est pas conservée dans le profil
  sauvegardé. La traçabilité durable des PDF reste donc incomplète.
